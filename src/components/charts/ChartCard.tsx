...
export default function ChartCard({ title, subtitle, right, children }: Props) {
  return (
    <Card className="p-3 sm:p-4 transition-transform duration-200 ease-out hover:-translate-y-px hover:shadow-[0_18px_40px_rgba(15,23,42,0.12)]">
      ...
      <div className="mt-3 sm:mt-4 h-44 sm:h-56 md:h-64">{children}</div>
    </Card>
  )
}